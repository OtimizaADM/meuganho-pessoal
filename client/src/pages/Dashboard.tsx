...
export default function Dashboard() {
  ...
  return (
    <div className="space-y-5">
      ...
      {dueAlerts.length > 0 && (
        <div className="card-premium overflow-hidden border-amber-200/60" style={{ borderColor: "oklch(0.84 0.12 80 / 0.5)" }}>
          <div className="flex items-center gap-2 px-5 py-3 border-b border-amber-100">
            <Bell className="w-3.5 h-3.5 text-amber-600" />
            <h2 className="text-xs font-semibold text-amber-800 uppercase tracking-wide">Alertas de vencimento</h2>
          </div>
          <div className="flex flex-wrap gap-2.5 px-5 py-3">
            {dueAlerts.map(({ card, daysUntilDue }) => {
              ...
              return (
                <div key={card.id} className="flex items-center gap-2 bg-amber-50/70 border border-amber-100 rounded-xl px-3 py-2">
